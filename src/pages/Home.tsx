    ...
    <>
      <div className="header">
        <div className="header-address f_c_c">
          <svg className="header-address-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 31">
            <path
              fill="#FFF"
              fillRule="evenodd"
          ...
          <span className="header-address-name" data-spm-anchor-id="a2ogi.13147251.0.i2">
            上海市人民政府
          </span>
          <svg className="header-address-jt" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 8">
            <path
              fill="#FFF"
              fillRule="evenodd"
      ...
      <div className="shoplist-title f_c_c">推荐商家</div>

      <div className="filter f_c_c">
        <a className="filter-item f_c_c" href="/">
          <span>综合排序</span>
          <svg viewBox="0 0 72 32" className="dropdown-icon">
      ...
      <div className="shoplist">
        {business.map((item, index) => {
          ...
          let activitiesAndsupports = [...activities, ...supports];
                  ...
                  <div className="shoplist-item-bottom-activity-item">
                    {activitiesAndsupports.map((aas, index) => {
                      return (
                        <p key={index}>
                          <span
                            style={{ backgroundColor: `#${aas.icon_color}` }}
                            className="shoplist-item-bottom-activity-icon"
                          >
                            {aas.icon_name}
                          </span>
                          {aas.description}
